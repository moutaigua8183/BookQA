            ...
            if 'encoder_outputs' not in model_kwargs:
                ...
                if len(input_ids.shape) == 3:
                    ...
                    for batch_idx in range(input_ids.shape[0]):
                        ...
                        encoder_output_list.append(encoder_outputs.last_hidden_state.reshape((-1, encoder_outputs.last_hidden_state.shape[-1])))
                    encoder_outputs.last_hidden_state = torch.stack(encoder_output_list, dim=0)
